resource "azurerm_hdinsight_interactive_query_cluster" "hdi_interactive" {
  name                = "interactive${local.safe_prefix}${local.safe_postfix}"
  ...
  count = var.enable_interactive_cluster ? 1 : 0
